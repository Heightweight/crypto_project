...
def des_encrypt(I, K):
    if isinstance(I,bytes) and isinstance(K, bytes):
        if len(I) != 8:
...
#---------------koniec szyfrowania
        ...
        raise "Blok danych lub klucz nie są typu bytes!"

I=b'\x01\x02\x03\x04\x05\x06\x07\x08'
K=b'\x01\x02\x03\x04\x05\x06\x07\x08'
print(I[5])
print(des_encrypt(I,K))